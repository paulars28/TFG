...
class MultKAN(nn.Module):
    ...
    def plot(self, folder="./figures", beta=3, metric='backward', scale=0.5, tick=False, sample=False, in_vars=None, out_vars=None, title=None, varscale=1.0):
        ...
        print(f"Profundidad de la red: {depth} capas.")
        for l in range(depth):
            print(f"Procesando capa {l}/{depth - 1}...")
            w_large = 2.0
            for i in range(self.width_in[l]):
                for j in range(self.width_out[l+1]):
                    print(f"  Procesando conexión ({l}, {i}, {j})...")
        ...
        print("Finalizado el proceso de generación de imágenes individuales.")
        ...
        print(f"Generando diagrama de red con {neuron_depth} capas...")
        ...
        for l in range(neuron_depth):
            print(f"Dibujando nodos de la capa {l}...")
    ...
    def attribute(self, l=None, i=None, out_score=None, plot=True):
        ...
        if self.acts == None:
            #self.get_act()
            print("No hay parámetros de activación acts guardados")
    ...
    def symbolic_formula(self, var=None, normalizer=None, output_normalizer = None):
        ...
        for l in range(len(self.width_in) - 1):
            print(f"Procesando capa simbólica {l+1}/{len(self.width_in) - 1}...")
