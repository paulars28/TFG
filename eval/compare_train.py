...
list = [
    "/home/gtav-tft/Desktop/paula/eval/train_metrics_tvae/10-5/tvae_training_metrics.csv",
    "/home/gtav-tft/Desktop/paula/eval/train_metrics_tvae/16-8/tvae_training_metrics.csv",
    "/home/gtav-tft/Desktop/paula/eval/train_metrics_tvae/32-16/tvae_training_metrics.csv",
    "/home/gtav-tft/Desktop/paula/eval/train_metrics_tvae/64-32/tvae_training_metrics.csv"
]
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Comparación de pérdida por época en TVAE por arquitectura')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("tvae_loss_comparison.png")
plt.show()
