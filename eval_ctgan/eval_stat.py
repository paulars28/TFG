...
def preprocess_data(real_data, ctgan_data, kan_data, numerical_columns, categorical_columns):
    scaler = MinMaxScaler()
    le_dict = {}
    real_data[numerical_columns] = scaler.fit_transform(real_data[numerical_columns])
    ctgan_data[numerical_columns] = scaler.transform(ctgan_data[numerical_columns])
    ...
    for col in categorical_columns:
        ...
        ctgan_data[col] = le.transform(ctgan_data[col].astype(str))
        kan_data[col] = le.transform(kan_data[col].astype(str))
        le_dict[col] = le
    return real_data, ctgan_data, kan_data
...
if __name__ == "__main__":
    ...
    sys.stdout = DualOutput("/home/gtav-tft/Desktop/paula/eval_ctgan/COMP_TAMAÑOSRED/"+arquitectura+"/dbeval/results_stats.txt")

    real_path = "/home/gtav-tft/Desktop/paula/eval_ctgan/DATASETS_EVALUATION/Heart Prediction Quantum Dataset.csv"
    ctgan_path = "/home/gtav-tft/Desktop/paula/eval_ctgan/COMP_TAMAÑOSRED/"+arquitectura+"/synthetic_heartdisease_mlp.csv"
    kan_path = "/home/gtav-tft/Desktop/paula/eval_ctgan/COMP_TAMAÑOSRED/"+arquitectura+"/synthetic_heartdisease_kan.csv"
    #ctgan_path = "/home/gtav-tft/Desktop/paula/eval/DATASETS_EVALUATION/synthetic_heartdisease_mlp.csv"
    ...
    real_data, ctgan_data, kan_data = preprocess_data(
        pd.read_csv(real_path).sample(500, random_state=42),
        pd.read_csv(ctgan_path).sample(500,  random_state=42),
