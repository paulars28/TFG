...
list = [
    "/home/gtav-tft/Desktop/paula/eval_ctgan/train_metrics_ctgan_ok/10-5/ctgan_training_metrics.csv",
    "/home/gtav-tft/Desktop/paula/eval_ctgan/train_metrics_ctgan_ok/24-12/ctgan_training_metrics.csv",
    "/home/gtav-tft/Desktop/paula/eval_ctgan/train_metrics_ctgan_ok/32-16/ctgan_training_metrics.csv",
    "/home/gtav-tft/Desktop/paula/eval_ctgan/train_metrics_ctgan_ok/64-32/ctgan_training_metrics.csv"
]
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Comparación de pérdida por época en CTGAN por arquitectura')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("ctgan_loss_comparison.png")
plt.show()
